...
pub unsafe extern "C" fn ndarray_argmin_axis(
    ...
    crate::ffi_guard!({
        ...
        if axis_len == 0 {
            crate::core::error::set_last_error("Cannot compute argmin along empty axis".to_string());
            return ERR_GENERIC;
        }
...
pub unsafe extern "C" fn ndarray_argmin(
    ...
    crate::ffi_guard!({
        ...
        let argmin_result = match wrapper.dtype {
            ...
            DType::Bool => {
                crate::core::error::set_last_error("argmin() not supported for Bool type".to_string());
                return ERR_GENERIC;
            }
        };
