    ...
    crate::ffi_guard!({
        ...
        let scalar = match wrapper.dtype {
            DType::Float64 => {
                ...
                ReductionScalar::F64(view.iter().cloned().fold(f64::NAN, |max, x| {
                    if max.is_nan() || x > max {
                        x
                    } else {
                        max
            ...
            DType::Float32 => {
                ...
                ReductionScalar::F32(view.iter().cloned().fold(f32::NAN, |max, x| {
                    if max.is_nan() || x > max {
                        x
                    } else {
                        max
            ...
            DType::Int64 => {
                ...
                ReductionScalar::I64(view.iter().cloned().fold(i64::MIN, |max, x| {
                    if x > max {
                        x
                    } else {
                        max
            ...
            DType::Int32 => {
                ...
                ReductionScalar::I32(view.iter().cloned().fold(i32::MIN, |max, x| {
                    if x > max {
                        x
                    } else {
                        max
            ...
            DType::Int16 => {
                ...
                ReductionScalar::I16(view.iter().cloned().fold(i16::MIN, |max, x| {
                    if x > max {
                        x
                    } else {
                        max
            ...
            DType::Int8 => {
                ...
                ReductionScalar::I8(view.iter().cloned().fold(i8::MIN, |max, x| {
                    if x > max {
                        x
                    } else {
                        max
            ...
            DType::Uint64 => {
                ...
                ReductionScalar::U64(view.iter().cloned().fold(u64::MIN, |max, x| {
                    if x > max {
                        x
                    } else {
                        max
            ...
            DType::Uint32 => {
                ...
                ReductionScalar::U32(view.iter().cloned().fold(u32::MIN, |max, x| {
                    if x > max {
                        x
                    } else {
                        max
            ...
            DType::Uint16 => {
                ...
                ReductionScalar::U16(view.iter().cloned().fold(u16::MIN, |max, x| {
                    if x > max {
                        x
                    } else {
                        max
            ...
            DType::Uint8 => {
                ...
                ReductionScalar::U8(view.iter().cloned().fold(u8::MIN, |max, x| {
                    if x > max {
                        x
                    } else {
                        max
