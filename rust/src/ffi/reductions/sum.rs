...
pub unsafe extern "C" fn ndarray_sum(
    ...
    crate::ffi_guard!({
        ...
        let (sum_result, result_dtype) = match wrapper.dtype {
            ...
            DType::Bool => {
                crate::core::error::set_last_error("sum() not supported for Bool type".to_string());
                return ERR_GENERIC;
            }
        };
...
pub unsafe extern "C" fn ndarray_sum_axis(
    ...
    crate::ffi_guard!({
        ...
        let result_wrapper = match wrapper.dtype {
            ...
            DType::Bool => {
                crate::core::error::set_last_error("sum_axis() not supported for Bool type".to_string());
                return ERR_GENERIC;
            }
        };
