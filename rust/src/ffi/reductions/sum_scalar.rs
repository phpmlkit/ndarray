    ...
    crate::ffi_guard!({
        ...
        let (sum_result, result_dtype) = match wrapper.dtype {
            ...
            DType::Int64 => {
                ...
                (view.iter().map(|&x| x as f64).sum(), DType::Int64)
            }
            DType::Int32 => {
                ...
                (view.iter().map(|&x| x as f64).sum(), DType::Int32)
            }
            DType::Int16 => {
                ...
                (view.iter().map(|&x| x as f64).sum(), DType::Int16)
            }
            DType::Int8 => {
                ...
                (view.iter().map(|&x| x as f64).sum(), DType::Int8)
            }
            DType::Uint64 => {
                ...
                (view.iter().map(|&x| x as f64).sum(), DType::Uint64)
            }
            DType::Uint32 => {
                ...
                (view.iter().map(|&x| x as f64).sum(), DType::Uint32)
            }
            DType::Uint16 => {
                ...
                (view.iter().map(|&x| x as f64).sum(), DType::Uint16)
            }
            DType::Uint8 => {
                ...
                (view.iter().map(|&x| x as f64).sum(), DType::Uint8)
            }
            DType::Bool => {
