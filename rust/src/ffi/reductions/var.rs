...
pub unsafe extern "C" fn ndarray_var(
    ...
    crate::ffi_guard!({
        ...
        let var_result = match wrapper.dtype {
            ...
            DType::Bool => {
                crate::core::error::set_last_error("var() not supported for Bool type".to_string());
                return ERR_GENERIC;
            }
        };
...
pub unsafe extern "C" fn ndarray_var_axis(
    ...
    crate::ffi_guard!({
        ...
        let result = match wrapper.dtype {
            ...
            DType::Bool => {
                crate::core::error::set_last_error("var_axis() not supported for Bool type".to_string());
                return ERR_GENERIC;
            }
        };
