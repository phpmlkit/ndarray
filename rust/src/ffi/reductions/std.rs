...
pub unsafe extern "C" fn ndarray_std(
    ...
    crate::ffi_guard!({
        ...
        let std_result = match wrapper.dtype {
            ...
            DType::Bool => {
                crate::core::error::set_last_error("std() not supported for Bool type".to_string());
                return ERR_GENERIC;
            }
        };
...
pub unsafe extern "C" fn ndarray_std_axis(
    ...
    crate::ffi_guard!({
        ...
        let result = match wrapper.dtype {
            ...
            DType::Bool => {
                crate::core::error::set_last_error("std_axis() not supported for Bool type".to_string());
                return ERR_GENERIC;
            }
        };
