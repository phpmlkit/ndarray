    ...
    crate::ffi_guard!({
        ...
        let scalar = match wrapper.dtype {
            DType::Float64 => {
                ...
                ReductionScalar::F64(view.product())
            }
            DType::Float32 => {
                ...
                ReductionScalar::F32(view.product())
            }
            DType::Int64 => {
                ...
                ReductionScalar::I64(view.product())
            }
            DType::Int32 => {
                ...
                ReductionScalar::I32(view.product())
            }
            DType::Int16 => {
                ...
                ReductionScalar::I16(view.product())
            }
            DType::Int8 => {
                ...
                ReductionScalar::I8(view.product())
            }
            DType::Uint64 => {
                ...
                ReductionScalar::U64(view.product())
            }
            DType::Uint32 => {
                ...
                ReductionScalar::U32(view.product())
            }
            DType::Uint16 => {
                ...
                ReductionScalar::U16(view.product())
            }
            DType::Uint8 => {
                ...
                ReductionScalar::U8(view.product())
            }
            DType::Complex64 => {
                ...
                ReductionScalar::C64(view.product())
            }
            DType::Complex128 => {
                ...
                ReductionScalar::C128(view.product())
            }
            DType::Bool => {
