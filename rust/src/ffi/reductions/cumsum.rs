//! Cumulative sum over flattened array (axis=None equivalent).
//!
//! Flattens the array in C-order and returns 1D cumulative sum.
...
pub unsafe extern "C" fn ndarray_cumsum(
    ...
    crate::ffi_guard!({
        ...
        let result_wrapper = match wrapper.dtype {
            ...
            DType::Bool => {
                crate::error::set_last_error("cumsum() not supported for Bool type".to_string());
                return ERR_GENERIC;
            }
        };
