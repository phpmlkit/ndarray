...
/// Greater-than-or-equal comparison (>=) for use with Zip::map_collect.
#[inline(always)]
fn gte<A: PartialOrd>(a: &A, b: &A) -> u8 {
    (a >= b) as u8
}
...
pub unsafe extern "C" fn ndarray_gte(
    ...
    crate::ffi_guard!({
        ...
        let result_wrapper = binary_op_comparison!(a_wrapper, a_meta, b_wrapper, b_meta, gte);
