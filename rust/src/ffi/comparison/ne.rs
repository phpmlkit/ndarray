    ...
    crate::ffi_guard!({
        ...
        let (result_wrapper, result_shape) = match out_dtype {
            DType::Float64 => binary_cmp_op_arm!(
                ...
                DType::Float64, extract_view_as_f64, ne
            ),
            DType::Float32 => binary_cmp_op_arm!(
                a_wrapper, a_offset, a_shape_slice, a_strides_slice,
                b_wrapper, b_offset, b_shape_slice, b_strides_slice,
                DType::Float32, extract_view_as_f32, ne
            ),
            DType::Int64 => binary_cmp_op_arm!(
                a_wrapper, a_offset, a_shape_slice, a_strides_slice,
                b_wrapper, b_offset, b_shape_slice, b_strides_slice,
                DType::Int64, extract_view_as_i64, ne
            ),
            DType::Int32 => binary_cmp_op_arm!(
                a_wrapper, a_offset, a_shape_slice, a_strides_slice,
                b_wrapper, b_offset, b_shape_slice, b_strides_slice,
                DType::Int32, extract_view_as_i32, ne
            ),
            DType::Int16 => binary_cmp_op_arm!(
                a_wrapper, a_offset, a_shape_slice, a_strides_slice,
                b_wrapper, b_offset, b_shape_slice, b_strides_slice,
                DType::Int16, extract_view_as_i16, ne
            ),
            DType::Int8 => binary_cmp_op_arm!(
                a_wrapper, a_offset, a_shape_slice, a_strides_slice,
                b_wrapper, b_offset, b_shape_slice, b_strides_slice,
                DType::Int8, extract_view_as_i8, ne
            ),
            DType::Uint64 => binary_cmp_op_arm!(
                a_wrapper, a_offset, a_shape_slice, a_strides_slice,
                b_wrapper, b_offset, b_shape_slice, b_strides_slice,
                DType::Uint64, extract_view_as_u64, ne
            ),
            DType::Uint32 => binary_cmp_op_arm!(
                a_wrapper, a_offset, a_shape_slice, a_strides_slice,
                b_wrapper, b_offset, b_shape_slice, b_strides_slice,
                DType::Uint32, extract_view_as_u32, ne
            ),
            DType::Uint16 => binary_cmp_op_arm!(
                a_wrapper, a_offset, a_shape_slice, a_strides_slice,
                b_wrapper, b_offset, b_shape_slice, b_strides_slice,
                DType::Uint16, extract_view_as_u16, ne
            ),
            DType::Uint8 => binary_cmp_op_arm!(
                a_wrapper, a_offset, a_shape_slice, a_strides_slice,
                b_wrapper, b_offset, b_shape_slice, b_strides_slice,
                DType::Uint8, extract_view_as_u8, ne
            ),
            DType::Bool => binary_cmp_op_arm!(
                a_wrapper, a_offset, a_shape_slice, a_strides_slice,
                b_wrapper, b_offset, b_shape_slice, b_strides_slice,
                DType::Bool, extract_view_as_bool, ne
            ),
        };
