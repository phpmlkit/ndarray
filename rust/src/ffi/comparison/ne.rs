...
pub unsafe extern "C" fn ndarray_ne(
    ...
    crate::ffi_guard!({
        ...
        let result_wrapper =
            binary_op_comparison!(a_wrapper, a_meta, b_wrapper, b_meta, ne, equality);
...
pub unsafe extern "C" fn ndarray_ne_scalar(
    ...
    crate::ffi_guard!({
        ...
        let result_wrapper =
            scalar_op_comparison!(a_wrapper, a_meta, scalar, scalar_dtype, !=, equality);
