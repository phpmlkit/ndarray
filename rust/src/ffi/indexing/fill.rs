...
use crate::helpers::view::{
    extract_view_mut_bool, extract_view_mut_f32, extract_view_mut_f64, extract_view_mut_i16,
    extract_view_mut_i32, extract_view_mut_i64, extract_view_mut_i8, extract_view_mut_u16,
    extract_view_mut_u32, extract_view_mut_u64, extract_view_mut_u8,
};
